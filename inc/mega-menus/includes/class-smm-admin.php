...
/**
 * WoonderShop Mega Menus Admin.
 *
 * @package  WoonderShop_Mega_Menus/Admin
 * @category Class
...
class SMM_Admin {
	...
	public function register_smm_sidebar() {
		register_sidebar( array(
			'name'			=> __( 'SMM Sidebar', 'woondershop-pt' ),
			'id'			=> 'smm-sidebar',
			'description'	=> __( 'Widgets in this area will be shown on all posts and pages.', 'woondershop-pt' ),
