...
/**
 * WoonderShop Mega Menus Frontend.
 *
 * @package  WoonderShop_Mega_Menus/Frontend
 * @category Class
...
class SMM_Frontend {
	...
	public function enqueue_frontend_scripts() {
		wp_enqueue_style( 'woondershop-mega-menus-frontend', WoonderShop_Mega_Menus()->plugin_url . 'assets/css/frontend.css', array(), WoonderShop_Mega_Menus()->version, 'all' );
	}
	...
	public function nav_menu_start_el( $item_output, $item, $depth = 0, $args = array() ) {
		if ( $this->_is_mega_menu( $item->ID ) && 0 === $depth && 'main-menu' === $args->theme_location ) {
