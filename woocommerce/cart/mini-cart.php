			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
						<!-- Start of WooCommerce template overrides -->
						<!-- Start of product Image -->
						<?php if ( ! $_product->is_visible() ) : ?>
							<?php echo str_replace( array( 'http:', 'https:' ), '', $thumbnail ); ?>
						<?php else : ?>
							<a class="woocommerce-mini-cart-item__image-link" href="<?php echo esc_url( $product_permalink ); ?>">
								<?php echo str_replace( array( 'http:', 'https:' ), '', $thumbnail ); ?>
							</a>
						<?php endif; ?>
						<!-- End of product image -->
						<?php echo wc_get_formatted_cart_item_data( $cart_item ); ?>
						<div class="woocommerce-mini-cart-item__content">
							<!-- Start of price -->
							...
							<div class="woocommerce-mini-cart-item__product-info">
								<!-- Start of qunatity -->
						...
						?>
						<!-- End of remove item -->
						<!-- End of WooCommerce template overrides -->
					</li>
					<?php
				}
			}
